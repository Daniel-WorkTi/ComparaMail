...
export function renderSignatureHtml(
  ...
  if (phoneHtml) {
    contactBits.push(
      `<tr><td style="padding:14px 0 0 0"><p style="margin:0;font-size:11px;line-height:1.2;font-family:Arial,sans-serif"><a href="${phoneHref}" style="color:#212121;text-decoration:none">${phoneHtml}</a> <span style="color:#646464;font-size:9px">(Custo de chamadas para rede móvel Nacional)</span></p></td></tr>`,
    );
  }
  if (emailHtml) {
    contactBits.push(
