...
/**
 * Path assinado para foto Workspace (Gmail / email HTML).
 * Requer HMAC — /api/wphoto rejeita pedidos sem sessão ou assinatura.
 */
export function workspacePhotoPath(
  email: string,
  ttlSec = 60 * 60 * 24 * 365,
): string {
...
/** @deprecated alias — preferir workspacePhotoPath */
